...
import { moods, hasSetNameStorageKey, userNameStorageKey } from "@/utils/constants";
...
class Calendone extends Component<RouteComponentProps<{}>, IState> {
    ...
    public readonly state: IState = {
        ...
        now: moment(),
        currIndex: -1,
        hasSetName: !!localStorage.getItem(userNameStorageKey) || !!localStorage.getItem(hasSetNameStorageKey),
        userName: ""
    };
